...
export default class StoryProgressionSystem {
    ...
    generateContextAwareDialogue(npcType: string): string {
        const baseDialogues = {
            ...
            tavern_keeper:
                'The tavern is quiet tonight. Strange times we live in.',
