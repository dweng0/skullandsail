...
export default function NPCDialogueUI({
  ...
  return (
    <div className="npc-dialogue-overlay" onClick={onClose}>
      <div className="npc-dialogue-menu" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="dialogue-content">
          {state === "menu" && (
            <div className="dialogue-menu-options">
              <p className="reputation-text">{getRepuationMessage()}</p>
              <div className="dialogue-buttons">
                <button className="dialogue-btn" onClick={handleGreet}>
                  Greet
                </button>
                <button className="dialogue-btn" onClick={handleLearnMore}>
                  Learn More
                </button>
                {npc.isQuestGiver && (
                  <button
                ...
                <button className="dialogue-btn cancel-btn" onClick={onClose}>
                  Leave
                </button>
              </div>
            </div>
          ...
          {state === "greet" && (
            <div className="dialogue-text-view">
              ...
              <button className="dialogue-btn" onClick={handleBack}>
                Back
              </button>
            </div>
          )}
          ...
          {state === "backstory" && (
            <div className="dialogue-text-view">
              <p className="dialogue-text backstory">{npc.backstory}</p>
              <button className="dialogue-btn" onClick={handleBack}>
                Back
              </button>
            </div>
          ...
          {state === "quests" && (
            <div className="quests-view">
              ...
              {availableQuests.length === 0 ? (
                <p className="no-quests">No quests available right now.</p>
              ) : (
                  ...
                  {availableQuests.map((quest) => (
                    <div key={quest.id} className="quest-item">
                      ...
                      <div className="quest-reward">
                        XP: {quest.reward.xp} | Gold: {quest.reward.gold}
                      </div>
                      <button
