...
export default function CharacterSetup({
  ...
  return (
    <div className="ui-panel" style={{ maxWidth: "500px", margin: "0 auto" }}>
        ...
        {availableShips.map((ship) => (
          <div
            ...
            style={{
              ...
              padding: "10px",
              border:
                selectedShip === ship ? "2px solid #ffd700" : "1px solid #666",
              borderRadius: "4px",
              cursor: "pointer",
              backgroundColor:
                selectedShip === ship
          ...
          >
            <input
              ...
              onChange={(e) => setSelectedShip(e.target.value as ShipClass)}
