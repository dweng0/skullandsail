...
export default function GameManager() {
  ...
  const handleCharacterSetup = (captainName: string, shipClass: ShipClass) => {
    setConfig({
      ...config,
      captainName,
      shipClass,
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden" }}>
      ...
      {gameState === "llm-setup" && <LLMSetup onConnect={handleLLMConnect} />}
    ...
    >
      ...
      <div style={{ marginBottom: "24px", maxWidth: "600px" }}>
        <p style={{ fontSize: "14px", lineHeight: "1.6" }}>
          Command your ship across a procedurally generated sea. Trade at ports,
          engage in turn-based battles, and follow an LLM-crafted storyline.
...
function LoadingScreen() {
  return (
    ...
    >
      ...
      <p style={{ fontSize: "12px", color: "#999" }}>Generating world...</p>
