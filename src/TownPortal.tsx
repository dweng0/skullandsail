        ...
        <div className="town-view ui-panel">
            ...
            {view === 'main' && (
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                    ...
                    <button onClick={() => setView('shipyard')}>
                        Shipyard
                    </button>
                ...
                <div>
                    ...
                    {UPGRADES.map((upgrade) => (
                        <div key={upgrade.type} style={{ marginBottom: '8px' }}>
                            ...
                            <button onClick={() => handleUpgrade(upgrade)}>
                                Buy
                            </button>
                        </div>
                    ))}

                    <h3 style={{ color: '#ffd700', marginTop: '16px' }}>
                        Hire Crew
                    </h3>
                    {CREW_ROLES.map((crew) => (
                        <div key={crew.name} style={{ marginBottom: '8px' }}>
                            ...
                            <button onClick={() => handleHireCrew(crew)}>
                                Hire
                            </button>
                        </div>
                    ))}
            ...
            {view === 'tavern' && (
                <div>
                    ...
                    <div style={{ marginBottom: '12px' }}>
                        <p>
                            The tavern is bustling with activity. You hear tales
                            of distant lands and lost treasures...
                        </p>
                    </div>
                    ...
                    <div style={{ marginBottom: '12px' }}>
                        ...
                        <div>
                            Rumors speak of a treasure wreck nearby. Interested?
                        </div>
                    </div>
