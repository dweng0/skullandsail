...
- [ ] UNCOVERED: "Greet" option shows NPC's greeting dialogue
- [x] "Learn More" shows NPC backstory
- [x] "Ask About Quests" shows available quests
- [ ] UNCOVERED: Dialogue is personalized based on player history

## Feature: Battle Encounter Narrative

- [ ] UNCOVERED: Approaching anomaly shows encounter narrative
- [ ] UNCOVERED: Battle outcome includes victory/defeat narrative
- [ ] UNCOVERED: Enemy encounters are themed to biome and storyline
